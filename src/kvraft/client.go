...
/*
the logic here is keep trying sending get, if :
1. empty: return ""
2. MsgId is for differentiate two get with same key(same as UUID), use random number instead of ++ to simplify question
3. the select leader part can be refined as the follower can tell client which server is the leader directly
*/
...
/*
pay attention to how server handle this situation
*/
