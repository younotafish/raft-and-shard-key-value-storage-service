...
type ShardKV struct {
	...
	lockStart time.Time // debug, to find stagger lock
	lockEnd   time.Time
	lockName  string
}
...
/*
another way may be encode shardId and clientId together, but this might more intuitive
*/
...
/*
paradigm: just save it directly, and give the logical part to the method itself
*/
...
/*
what are ownShards and waitShardIds?
*/
...
func (kv *ShardKV) pullConfig() {
	for {
		...
		case <-kv.pullConfigTimer.C:
			...
			// if the arg.Num > the latest version, it will just return the latest one
